	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'field':
				...
				overlay1 = new BGSprite('field/overlay1', -2180, -1300, 1, 1);
				overlay1.scale.set(2, 2);
				overlay1.updateHitbox();

				overlay2 = new BGSprite('field/overlay2', -1580, -300, 1, 1);
				overlay2.scale.set(1.5, 1.5);
				overlay2.updateHitbox();

				overlay3 = new BGSprite('field/overlay3', -1380, -650, 1, 1);
				overlay3.scale.set(1.5, 1.5);
				overlay3.updateHitbox();

				overlay4 = new BGSprite('field/overlay4', -1380, -650, 1, 1);
				overlay4.scale.set(1.5, 1.5);
				overlay4.updateHitbox();

				overlay5 = new BGSprite('field/overlay5', -1380, -490, 1, 1);
				overlay5.scale.set(1.5, 1.5);
				overlay5.updateHitbox();

			case 'starCourt':
				var bg:BGSprite = new BGSprite('starCourt/StarCourtBG', -1230, -1200, 1.2, 1.2);
				add(bg);

				var stage:BGSprite = new BGSprite('starCourt/StarcourtStage', -1230, -1200, 0.97, 0.97);
				add(stage);
